...
* The original package name 'io.github.icon02.springboot-authentication-template' is invalid and this project uses 'io.github.icon02.springbootauthenticationtemplate' instead.
